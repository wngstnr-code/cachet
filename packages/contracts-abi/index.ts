...
/** ERC-721 pembawa coverage. Di sinilah registerAndMint. */
export const CachetCertificateAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
  ...
  {
    "type": "function",
    "name": "MAX_DECLARED_VALUE_CEILING",
    "inputs": [],
    "outputs": [
      {
        "name": "",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct ICachetCertificate.CertData",
        "components": [
          {
            "name": "entryId",
            "type": "uint256",
    ...
    "inputs": [
      {
        "name": "r",
        "type": "tuple",
        "internalType": "struct ICachetCertificate.MintRequest",
        "components": [
          {
            "name": "to",
            "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract ICachetRegistry"
      }
    ],
    "stateMutability": "view"
  },
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract ICachetVault"
      }
    ],
    "stateMutability": "view"
  },
...
/** Bond, premi, pembayaran klaim */
export const CachetVaultAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract ICachetCertificate"
      }
    ],
    "stateMutability": "view"
  },
  ...
  },
  {
    ...
    "outputs": [
      ...
      },
      {
        "name": "status",
        "type": "uint8",
        "internalType": "enum IChallengeManager.Status"
      },
      {
        "name": "evidenceURI",
        "type": "string",
...
/** Token pembayaran testnet (6 desimal) */
